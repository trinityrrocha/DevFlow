...
const exerciseTransaction = () => spawnSync(bash, ['-c', `
  ...
  source "$2"
  install_transaction_begin 0.4.10-alpha 0123456789012345678901234567890123456789 internal true true 05-build-images
...
check('version tag is accepted', normalize('devflow-backend:0.4.10-alpha').status === 0);
