...
export default function Tasks() {
  ...
  return <div className="animate-fadeIn space-y-6">
    <header className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center"><div><h1 className="text-2xl font-bold">Tarefas</h1><p className="mt-1 text-sm text-slate-500">Ciclo de desenvolvimento e prioridades da equipe.</p></div>{canCreate && <button type="button" onClick={() => setNewTaskOpen(true)} className="btn-primary"><Plus className="mr-2 h-4 w-4" />Nova Tarefa</button>}</header>
