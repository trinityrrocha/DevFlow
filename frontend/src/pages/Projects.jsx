...
const emptyForm = { name: '', code: '', client_id: '', default_environment_id: '', github_repository_url: '', description: '', status: 'ACTIVE', responsibles: [] };
...
export default function Projects() {
  ...
  const load = useCallback(async () => {
    ...
    try { const response = await api.get('/catalogs/projects', { params: filters }); setData(response.data); }
